     ...
     window.addEventListener("keydown", function(e){
         switch( e.keyCode ) {
            ...
            case 65:	// a - snýr neðri armi
			    theta[1] = Math.min(45, theta[1]+5);
                break;
            case 83:	// s - snýr neðri armi
			    theta[1] = Math.max(-45, theta[1]-5);
                break;
...
function topArm()
{
    var s = scalem(TOP_ARM_WIDTH, TOP_ARM_HEIGHT-3, TOP_ARM_WIDTH);
    var instanceMatrix = mult( translate( 0.0, TOP_ARM_HEIGHT / 5.0, 0.0 ), s);
    var t = mult(modelViewMatrix, instanceMatrix);
    gl.uniformMatrix4fv( modelViewMatrixLoc,  false, flatten(t) );
    gl.drawArrays( gl.TRIANGLES, 0, NumVertices );
}
...
var render = function() {
    ...
    var mv = lookAt( vec3(0.0, 2.0, zDist-5), vec3(0.0, 2.0, 0.0), vec3(0.0, 1.0, 0.0) );
